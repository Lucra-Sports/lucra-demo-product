...
class SessionManager: ObservableObject {
    ...
    private func presentMatchupAlert(created: Bool) {
        ...
        let message = "You've \(verb) a Lucra matchup, once \(verbAction) the matchup, go back to RNG tournaments and generate a new number to complete your participation in this matchup!\n NOTE: If you have multiple matchups open, your scores will be applied to the oldest matchup open, one at a time"
